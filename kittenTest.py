...
import mechanize, cookiejar, random
...
class anonBrowser(mechanize.Browser):
    def __init__(self, proxies = [], user_agents = []):
        ...
        self.user_agents = user_agents + ['Mozilla/4.0 ','FireFox/6.0','ExactSearch', 'Nokia7110/1.0']
...
for attempt in range(1,5):
    ...
    for cookiejar in ab.cookie_jar:
        print(cookiejar)
